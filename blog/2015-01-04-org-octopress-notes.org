...
#+JEKYLL_LAYOUT: post
#+JEKYLL_CATEGORIES: eamcs octopress github
...
- ~<site-root>/_deploy~ is a subdirectory that is maintained by
  Jeckyl.  It is /also/ a git repository with the following remotes:
  #+BEGIN_EXAMPLE
    origin  <your-github-repository-path> (fetch)
    origin  <your-github-repository-path> (push)
  #+END_EXAMPLE
...
you need to go into the ~_deploy~ subdirectory and do something like
this:
